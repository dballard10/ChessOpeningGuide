...
const WhiteOpeningList = () => {
  ...
  return (
    <div>
      <OpeningCategoryList openingCategories={processedOpenings} side="white" />
    </div>
  );
};

export default WhiteOpeningList;
