...
const MoveSequence: React.FC<MoveSequenceProps> = ({
  ...
  return (
    <div className="p-4 bg-white/5 backdrop-blur-sm rounded-lg mt-4 max-h-[30rem] md:max-h-96 overflow-y-auto self-start max-w-[560px] transition-all duration-500 ease-in-out will-change-transform will-change-opacity">
